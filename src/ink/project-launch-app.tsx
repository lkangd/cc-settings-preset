...
export function ProjectLaunchApp({ presets, detected, statesByPreset, lastUsedName, onSubmit }: ProjectLaunchAppProps) {
  ...
  return (
    <Box flexDirection="column">
      <Text bold color="cyan">Select project launch preset</Text>
      <Text dimColor>←/→ switch column · p plugins · s skills · m mcps · t sort · space toggle · enter launch · q quit</Text>
      <Box marginTop={1}>
